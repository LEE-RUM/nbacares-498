...
urlpatterns = [
    ...
    path('tutorials/', views.view_tutorials, name='tutorials'),
    path('services/', views.view_services, name ='access_services'),
    path('services/email', views.view_services_email, name ='access_services_email'),
